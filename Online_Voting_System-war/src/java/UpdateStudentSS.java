 ...
 * @author akhil
 */
@WebServlet(urlPatterns = {"/Online_Voting_System-war/UpdateStudentSS"})
public class UpdateStudentSS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect("/Online_Voting_System-war/Student/ViewProfile.jsp"); 
        }
    }
