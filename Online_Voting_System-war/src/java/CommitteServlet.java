 ...
 * @author akhil
 */
@WebServlet(urlPatterns = {"/Online_Voting_System-war/CommitteServlet"})
public class CommitteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Committee a = committeeFacade.checkLogin(una,ps);
            if(a == null)
            {
                request.getRequestDispatcher("/Committee/index.jsp?err=yes").include(request,response);
            }
            else
            {
