 ...
 * @author akhil
 */
@WebServlet(urlPatterns = {"/GetVoteID"})
public class GetVoteID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            session.setAttribute("eleposlist", ep);
            response.sendRedirect("/Online_Voting_System-war/Admin/ViewVote.jsp");
         }
    }
