    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        <div class="nano">
            <div class="nano-content active">
                <ul>
                    <div class="logo"><a href="../ContesterHome"><span>Election Management System</span></a></div>
                    <li><a href="../ContesterHome"><i class="ti-home"></i> Home</a></li>
                    <li><a href="../ViewVoteStat"><i class="ti-email"></i> View Vote Status</a></li>
                    
                    <li><a class="sidebar-sub-toggle"><i class="ti-list"></i>Profile <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="ViewProfile.jsp">View Profile</a></li>
                            <li><a href="../EditContesterS">Edit Profile</a></li>   
                        </ul>
                    </li>
