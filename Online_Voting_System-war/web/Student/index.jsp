<%-- 
    Document   : index
    Created on : 19 Nov, 2022, 11:27:16 AM
    Author     : akhil
--%>
                ...
                <div class="col-lg-4">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <h4>Student Login</h4>
                            <form action="../Online_Voting_System-war/StudentServlet" method="POST">
                                <div class="form-group">
                                    <label>Username</label>
                                    <input type="email" id="sname" name ="sname" class="form-control" placeholder="Email" required="true">
                                </div>
                                <div class="form-group">
