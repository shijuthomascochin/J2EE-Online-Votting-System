<%-- 
    Document   : index.jsp
    Created on : 16 Nov, 2022, 8:41:46 PM
    Author     : akhil
--%>
                ...
                <div class="col-lg-4">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <h4>Admin Login</h4>
                            <form action="../Online_Voting_System-war/AdminServlet" method="POST">
                                <div class="form-group">
                                    <label>Username</label>
                                    <input type="text" id="aname" name ="aname" class="form-control" placeholder="" required="true">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" id="apass" name="apass" class="form-control" placeholder="" required="true">
                                </div>
                                <div class="checkbox">
                                    <label>
